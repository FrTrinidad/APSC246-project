...
A custom-built handheld retro gaming console powered by a Rasbperry Pi 4. This project integrates hardware components such as a display, joystick, and push buttons to create an interactive gaming system. The prototype features Pong as the initial game, with plans to expand functionality and add additional games. The project focuses on hardware and software integration, GPIO input handling, and a compact system design.
